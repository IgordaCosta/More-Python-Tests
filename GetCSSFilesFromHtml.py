...
def extract_css_js_files(folder_path):
    ...
    js_folder_path = os.path.join(folder_path, 'CSSFilesInHtml')
                            ...
                            if './css/' in content:
                                ...
                                if r'<!--' in content:
                                    ...
                                    if r'-->' in content:
                                        ...
                                        content2 = content.replace(' ', '').replace('"', "'").replace("'",'').replace(".css", './css/').split("./css/")[1] + '.css'
    ...
    with open(js_folder_path + '\\' + 'CSSFilesInHtml.txt', "w") as file:
