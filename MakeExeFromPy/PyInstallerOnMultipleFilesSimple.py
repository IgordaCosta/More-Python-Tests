...
def create_executables(src_folder, output_folder, spec_folder,src_folder2, error_log_file):
    ...
    python_files = [file for file in os.listdir(src_folder2) if file.endswith('.py')]
    ...
    with open(error_log_file, 'w', newline='') as error_log:
        ...
        for file in python_files:
            ...
            # except:
            #     pass
            # # print( error_message = result.stderr.decode('utf-8').strip())
            # # error_writer.writerow([file, error_message])
...
src_folder2 = r'C:\Users\Tigereye\Desktop\PythonFilesIntoExes\PythonFilesSelected2' + '\\'

create_executables(source_folder, output_folder, spec_folder, src_folder2, error_log_file)
