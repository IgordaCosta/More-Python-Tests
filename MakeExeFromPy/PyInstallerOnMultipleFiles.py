    ...
    with open(error_log_file, 'w', newline='') as error_log:
        ...
        for file in python_files:
            ...
            command = [
                ...
                '--name', output_name,  # Set the output executable name
                '--distpath', output_folder,  # Specify the output folder
                '--specpath', spec_folder,  # Specify the spec file output folder
